            ...
            <div className="main xl:w-3/4 lg:w-2/3 lg:pr-[15px]">
              ...
              <div className="content">
                ...
                <div className="body1 mt-2">
                  I’ve always been passionate about BusinessTools and shapewear and
                ...
                <div className="body1 mt-4">
                  ...
                  great support and is so comfy I can sleep in it. I also love
                  our Seamless Sculpt Bodysuit – it{String.raw`'s`} the perfect
                  all in one sculpting, shaping and smoothing shapewear piece
                  with different levels of support woven throughout.
                </div>
                <div className="heading4 md:mt-8 mt-5">
                  How did SKIMS start?
                </div>
                <div className="body1 mt-4">
                  ...
                  day – it is the only BusinessTools I have now, it{String.raw`'s`}{" "}
                  so comfortable and stretchy and light enough that you can wear
                  anything over it.
                </div>
                <div className="quote-block md:mt-8 mt-5 py-6 md:px-10 px-6 border border-line md:rounded-[20px] rounded-2xl flex items-center md:gap-10 gap-6">
                  <Icon.Quotes
                    className="text-green text-3xl rotate-180 flex-shrink-0"
                    weight="fill"
                  />
                  <div>
                    <div className="heading6">
                      {String.raw`"`}For bras, I love our Cotton Jersey Scoop
                      Bralette – it{String.raw`'s`} lined with this amazing
                      power mesh so you get great support and is so comfy I can
                      sleep in it.{String.raw`"`}
                    </div>
                ...
                <div className="body1 md:mt-8 mt-5">
                  For bras, I love our Cotton Jersey Scoop Bralette – it
                  {String.raw`'s`} lined with this amazing power mesh so you get
                  great support and is so comfy I can sleep in it. I also love
                  our Seamless Sculpt Bodysuit – it{String.raw`'s`} the perfect
                ...
                <div className="left flex items-center gap-3 flex-wrap">
                  ...
                  <div className="list flex items-center gap-3 flex-wrap">
                    <div
                      ...
                      onClick={() => handleBlogClick("Digital")}
                    >
                      Digital
                    </div>
                    <div
              ...
              <div className="list-comment md:mt-[60px] mt-8">
                ...
                <div className="list-review mt-6">
                  <div className="item">
                    ...
                    <div className="action flex justify-between mt-3">
                      ...
                      <div className="right">
                        <div className="reply-btn text-button text-secondary">
                          Reply
                        </div>
                      </div>
                    </div>
                ...
                <div
                  id="form-review"
                  className="form-review md:p-10 p-6 bg-surface rounded-xl md:mt-10 mt-6"
                >
              ...
              <div className="about-author">
                <div className="heading flex gap-5">
                  ...
                  <div>
                    ...
                    <div className="button-main bg-white text-black px-5 py-1 border border-line text-button rounded-full capitalize mt-2">
                      Follow
                    </div>
                  </div>
                </div>
                <div className="text-secondary mt-5">
                  {blogMain.author} is a writer who draws. He’s the Bestselling
                  author of “Number of The Year”. Donec vitae tortor efficitur,
                  convallis lelobortis elit.
                </div>
