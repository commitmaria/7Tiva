...
import MenDigital from "@/components/Home11/MenDigital";
import Banner from "@/components/Home9/Banner";
import WomenDigital from "@/components/Home11/WomenDigital";
...
export default function HomeEleven() {
  return (
    <>
      ...
      <TrendingNow />
      <MenDigital data={productData} start={0} limit={3} />
      <Banner />
      <WomenDigital data={productData} start={0} limit={3} />
