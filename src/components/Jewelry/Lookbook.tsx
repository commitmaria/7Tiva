              ...
              <div className="item relative rounded-xl overflow-hidden">
                ...
                <div className="dots absolute top-[22%] left-[55%] cursor-pointer">
                  ...
                  <div
                    ...
                    onClick={() => handleDetailProduct("69")}
                  >
                    <div className="text-title name">silver necklace</div>
                    <div className="price text-center">$60</div>
                ...
                <div className="dots absolute top-[42%] left-[32%] cursor-pointer">
                  ...
                  <div
                    className="product-infor bg-white rounded-2xl p-4 cursor-pointer"
                    onClick={() => handleDetailProduct("66")}
                  >
                    <div className="text-title name">golden ring</div>
                    <div className="price text-center">$50</div>
                    <div className="text-center underline mt-1 text-button-uppercase duration-300 text-secondary2 hover:text-black">
                      View
                    </div>
                  </div>
                ...
                <div className="dots bottom-dot absolute bottom-[20%] left-[58%] cursor-pointer">
                  ...
                  >
                    ...
                    <div className="price text-center">$40</div>
                    <div className="text-center underline mt-1 text-button-uppercase duration-300 text-secondary2 hover:text-black">
                      View
                    </div>
                  </div>
              ...
              <div className="item relative rounded-xl overflow-hidden">
                ...
                <div className="dots absolute top-[26%] left-[54%] cursor-pointer">
                  ...
                  >
                    ...
                    <div className="price text-center">$45</div>
                    <div className="text-center underline mt-1 text-button-uppercase duration-300 text-secondary2 hover:text-black">
                      View
                    </div>
                  </div>
                ...
                <div className="dots absolute top-[29%] left-[30%] cursor-pointer">
                  ...
                  >
                    <div className="text-title name">Golden Ring</div>
                    <div className="price text-center">$48</div>
                    <div className="text-center underline mt-1 text-button-uppercase duration-300 text-secondary2 hover:text-black">
                      View
                    </div>
                  </div>
