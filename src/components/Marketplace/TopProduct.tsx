        ...
        <div className="list grid xl:grid-cols-3 sm:grid-cols-2 gap-4 md:mt-10 mt-6">
          ...
          >
            ...
            <div className="product-infor">
              ...
              <div className="flex items-center gap-3 mt-3">
                <span className="text-title inline-block">$300</span>
                <del className="caption2 text-secondary">$350</del>
              </div>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div className="product-infor">
              <span className="caption2 uppercase block">UMINO</span>
              <span className="caption2 mt-2">
                Logitech Watch Aluminum Case -Pride Edition
              </span>
              <div className="flex gap-0.5 mt-2">
                <Icon.Star weight="fill" className="text-sm text-yellow" />
                <Icon.Star weight="fill" className="text-sm text-yellow" />
          ...
          >
            ...
            <div className="product-infor">
              <span className="caption2 uppercase block">UMINO</span>
              <span className="caption2 mt-2">
                Apple iPad Air 4 10.9-inch Wi-Fi 256GB Blue
              </span>
              <div className="flex gap-0.5 mt-2">
                <Icon.Star weight="fill" className="text-sm text-yellow" />
                <Icon.Star weight="fill" className="text-sm text-yellow" />
