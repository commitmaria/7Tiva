        ...
        <div className="list-product grid sm:grid-cols-3">
          <div className="item relative overflow-hidden">
            ...
            <div className="dots absolute top-[38%] left-[45%] cursor-pointer">
              ...
              <div
                ...
                onClick={() => handleDetailProduct("3")}
              >
                <div className="text-title name">Off-The-Shoulder</div>
                <div className="price text-center">$32</div>
          ...
          <div className="item relative overflow-hidden">
            ...
            <div className="dots absolute top-[30%] left-[70%] cursor-pointer">
              ...
              <div
                className="product-infor bg-white rounded-2xl p-4"
                onClick={() => handleDetailProduct("13")}
              >
                <div className="text-title name">Mesh Code activation</div>
                <div className="price text-center">$35</div>
                <div className="text-center underline mt-1 text-button-uppercase duration-300 text-secondary2 hover:text-black">
                  View
                </div>
              </div>
          ...
          <div className="item relative overflow-hidden">
            ...
            <div className="dots absolute top-[34%] left-[35%] cursor-pointer">
              ...
              >
                <div className="text-title name">d-apps Pockets</div>
                <div className="price text-center">$19</div>
                <div className="text-center underline mt-1 text-button-uppercase duration-300 text-secondary2 hover:text-black">
                  View
                </div>
              </div>
