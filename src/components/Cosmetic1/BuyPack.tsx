        ...
        <div className="container grid sm:grid-cols-2 max-sm:flex max-sm:w-full flex-col max-sm:flex-col-reverse items-center">
          <div className="main-content w-full">
            ...
            <div className="list-product mt-8">
              <div
                className="product-item pb-5 border-b border-line cursor-pointer"
                onClick={() => handleDetailProduct("43")}
              >
                <div className="product-main flex items-center justify-between">
                  ...
                  <div className="right">
                    <div className="text-title">
                      $<span className="product-price">15</span>,000
                    </div>
                  </div>
                </div>
              </div>
              <div
                className="product-item pb-5 border-b border-line cursor-pointer mt-5"
                onClick={() => handleDetailProduct("44")}
              >
                <div className="product-main flex items-center justify-between">
                  <div className="left flex items-center gap-7">
                    <Image
                  ...
                  <div className="right">
                    <div className="text-title">
                      $<span className="product-price">10</span>,000
                    </div>
                  </div>
                </div>
              </div>
              <div
                className="product-item pb-5 border-b border-line cursor-pointer mt-5"
                onClick={() => handleDetailProduct("42")}
              >
                <div className="product-main flex items-center justify-between">
                  <div className="left flex items-center gap-7">
                    <Image
                  ...
                  <div className="right">
                    <div className="text-title">
                      $<span className="product-price">20</span>,000
                    </div>
                  </div>
                </div>
              </div>
