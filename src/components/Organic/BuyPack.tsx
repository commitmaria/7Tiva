      ...
      <div className="buy-pack-block md:py-20 py-10 md:mt-20 mt-10 relative">
        ...
        <div className="container">
          <div className="heading">
            ...
            <div className="block text-center text-white mt-3">
            ...
            <div className="main-content text-white lg:pr-[84px] sm:pr-12 w-full">
              <div className="list-product md:mt-10 mt-6">
                <div className="product-item pb-5 border-b border-line">
                  <div
                    className="product-main flex items-center justify-between cursor-pointer"
                    onClick={() => handleDetailProduct("123")}
                  >
                    <div className="left flex items-center gap-7">
                      ...
                      <div className="infor">
                        ...
                        <div className="caption2 product-brand text-secondary2 uppercase mt-1">
                          Glurmarket
                        </div>
                      </div>
                    </div>
                    <div className="right">
                      <div className="text-title">
                        $<span className="product-price">4</span>,000/Kg
                      </div>
                    </div>
                  </div>
                </div>
                <div className="product-item pb-5 border-b border-line mt-5">
                  <div
                    className="product-main flex items-center justify-between cursor-pointer"
                    onClick={() => handleDetailProduct("124")}
                  >
                    <div className="left flex items-center gap-7">
                      <Image
                        src={"/images/product/1000x1000.png"}
                    ...
                    <div className="right">
                      <div className="text-title">
                        $<span className="product-price">3</span>,000/Kg
                      </div>
                    </div>
                  </div>
                </div>
                <div className="product-item pb-5 border-b border-line mt-5">
                  <div
                    className="product-main flex items-center justify-between cursor-pointer"
                    onClick={() => handleDetailProduct("125")}
                  >
                    <div className="left flex items-center gap-7">
                      <Image
                        src={"/images/product/1000x1000.png"}
            ...
            <div className="popular-product sm:pl-4 max-sm:pb-6">
              <div className="item relative">
                ...
                <div className="dots absolute top-[15%] left-[35%] cursor-pointer">
                  ...
                  <div
                    className="product-infor bg-white rounded-2xl p-4 cursor-pointer"
                    onClick={() => handleDetailProduct("123")}
                  >
                    <div className="text-title name">green cabbage</div>
                    <div className="price text-center">$10</div>
                ...
                <div className="dots bottom-dot absolute bottom-[25%] left-[62%] cursor-pointer">
                  ...
                  >
                    <div className="text-title name">green cabbage</div>
                    <div className="price text-center">$15</div>
                    <div className="text-center underline mt-1 text-button-uppercase duration-300 text-secondary2 hover:text-black">
                      View
                    </div>
                  </div>
