        ...
        <div className="container flex lg:items-center justify-between gap-y-6 flex-wrap">
          ...
          <div className="product-infor md:w-1/2 w-full lg:pl-16 md:pl-6">
            ...
            <div className="flex items-center gap-3 flex-wrap mt-5 pb-6 border-b border-line">
              <div className="product-price heading5 text-white">
              ...
              <div className="desc text-secondary2 mt-3">
            ...
            <div className="list-action mt-6">
              ...
              <div className="choose-size mt-5">
                <div className="heading flex items-center justify-between">
                  <div className="text-title text-white">
                    Size:
                    <span className="text-title size pl-1">
                      {activeSize ? `${activeSize}mm` : ""}
                    </span>
                  </div>
                </div>
                <div className="list-size flex items-center gap-2 flex-wrap mt-3">
                  {productMain.sizes.map((item, index) => (
                    <div
                      className={`size-item py-3 px-4 flex items-center justify-center text-button normal-case rounded-xl bg-white border border-line ${
              ...
              <div className="choose-quantity flex items-center lg:justify-between gap-5 gap-y-3 mt-5">
                <div className="quantity-block md:p-3 p-2 flex items-center justify-between rounded-lg border border-line w-[140px] flex-shrink-0">
                  ...
                  />
                  <div className="body1 font-semibold text-white">
                    {productMain.quantityPurchase}
                  </div>
                  <Icon.Plus
                    size={20}
                ...
                <div
                  className="button-main w-full text-center border border-line"
              ...
              <div className="button-block mt-5">
                {/* End PayPalButton*/}
                <PayPalButton
                  className="button-main w-full text-center bg-white text-black"
                  amount={productMain.price * productMain.quantityPurchase}
                  onSuccess={(order) => {
                    console.log("Paid product ID:", productMain.id);
                    console.log("Selected color:", activeColor);
                    console.log("Selected size:", activeSize);
                    console.log("Quantity:", productMain.quantityPurchase);
                    console.log("PayPal order details:", order);

                    // Cart update logic after payment
                    if (
