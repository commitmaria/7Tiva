          ...
          <div className="product-infor md:w-1/2 w-full lg:pl-16 md:pl-6">
            ...
            <div className="list-action mt-6">
              ...
              <div className="button-block mt-5">
                {/* PayPalButton*/}
                <PaypalButton
                  className="button-main w-full text-center bg-black text-white border border-black"
                  amount={productMain.price * productMain.quantityPurchase} // total price
                  onSuccess={(order) => {
                    ...
                    // Optionally, you can update your cart, close modal, or redirect
                    // Example:
                    // updateCart(productMain.id, 0); // remove from cart
                    // openModalCart(false); // close modal
                  }}
                />
                {/* End PayPalButton*/}
              </div>
