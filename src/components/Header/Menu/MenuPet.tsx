          ...
          <div className="top-nav-menu-main flex items-center justify-between h-full">
                    ...
                    <div className="sub-menu absolute py-3 px-5 -left-10 w-max grid grid-cols-4 gap-5 bg-white rounded-b-xl">
                      <ul>
                        ...
                        <li>
                          <Link
                            ...
                            className={`text-secondary duration-300 ${
                              pathname === "/homepages/Digital2" ? "active" : ""
                            }`}
                          >
                            Home Digital 2
                          </Link>
                        ...
                        <li>
                          <Link
                            ...
                            className={`text-secondary duration-300 ${
                              pathname === "/homepages/Digital3" ? "active" : ""
                            }`}
                          >
                            Home Digital 3
                          </Link>
                      ...
                      <ul>
                        <li>
                          <Link
                            ...
                            className={`text-secondary duration-300 ${
                              pathname === "/homepages/Digital7" ? "active" : ""
                            }`}
                          >
                            Home Digital 7
                          </Link>
                        ...
                        <li>
                          <Link
                            ...
                            className={`text-secondary duration-300 ${
                              pathname === "/homepages/Digital8" ? "active" : ""
                            }`}
                          >
                            Home Digital 8
                          </Link>
                        ...
                        <li>
                          <Link
                            ...
                            className={`text-secondary duration-300 ${
                              pathname === "/homepages/Digital9" ? "active" : ""
                            }`}
                          >
                            Home Digital 9
                          </Link>
                      ...
                      <ul>
                        ...
                        <li>
                          <Link
                            href="/homepages/pet"
                            className="text-secondary duration-300 active"
                          >
                            Home Pet Store
                          </Link>
                        </li>
            ...
            <div className="right flex items-center gap-1 max-[1240px]:hidden">
              <div className="text-button">
                Limited Time Offer:{" "}
                <span className="text-red">Free shipping</span> on all orders
                over $50
              </div>
            </div>
          </div>
