...
const Sale: React.FC<Props> = ({ data, productId }) => {
  ...
  // dynamic total for PayPal (price × selected purchase quantity)
  const totalPrice =
            ...
            <div className="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
              ...
              <div className="list-action mt-6">
                ...
                <div className="button-block mt-5">
                  {/* PayPalButton*/}
                  <PayPalButton
                    key={`sale-${productMain.id}-${productMain.quantityPurchase}-${totalPrice}`}
                    amount={totalPrice}
                    onSuccess={(details) => {
                      console.log("✅ PayPal payment completed:", details);
                      alert("Payment successful!");
                      // optional: add post-payment behavior, e.g. addToCart({...productMain}); openModalCart();
                    }}
                    onError={(err) => {
                ...
                <div className="item">
                  <div className="heading flex items-center justify-between">
                    <div className="user-infor flex gap-4">
                      ...
                      <div className="user">
                        <div className="flex items-center gap-2">
                          <div className="text-title">Michael</div>
                  ...
                  <div className="action mt-3">
                    <div className="flex items-center gap-4">
                      <div className="like-btn flex items-center gap-1 cursor-pointer">
                        ...
                        <div className="text-button">5</div>
                      </div>
                      <Link
                        href={"#form-review"}
