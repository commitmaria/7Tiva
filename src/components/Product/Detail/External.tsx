            ...
            <div className="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
              ...
              <div className="list-action mt-6">
                ...
                <div className="button-block mt-5">
                  {/*  PayPalButton*/}
                  <PayPalButton
                    key={`${productMain.id}-${productMain.price}-${productMain.quantityPurchase}`}
                    amount={productMain.price * productMain.quantityPurchase}
                    onSuccess={(details) => {
                      console.log("✅ PayPal payment completed:", details);
                      alert(
                        `Payment successful! Transaction ID: ${details.id}`
                      );
                    }}
                    onError={(err) => {
                    ...
                    <div className="item">
                      <div className="heading flex items-center justify-between">
                        <div className="user-infor flex gap-4">
                          ...
                          <div className="user">
                            <div className="flex items-center gap-2">
                              <div className="text-title">Sophia</div>
