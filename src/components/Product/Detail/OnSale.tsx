...
const OnSale: React.FC<Props> = ({ data, productId }) => {
  ...
  // dynamic amount for PayPal: product price × selected purchase quantity
  const totalPrice =
                      ...
                      <div className="item">
                        <div className="heading flex items-center justify-between">
                          <div className="user-infor flex gap-4">
                            ...
                            <div className="user">
                              <div className="flex items-center gap-2">
                                <div className="text-title">Emily</div>
            ...
            <div className="product-infor md:w-1/2 w-full lg:pl-[30px] md:pl-4">
              ...
              <div className="list-action mt-6">
                ...
                <div className="button-block mt-5">
                  {/* PayPalButton*/}
                  <PayPalButton
                    key={`onsale-${productMain.id}-${productMain.quantityPurchase}-${totalPrice}`}
                    amount={totalPrice}
                    onSuccess={(details) => {
                      console.log("✅ PayPal payment completed:", details);
                      alert("Payment successful!");
                      // optionally add post-payment logic:
                      // if you want to add the item to cart or open a modal, call your handlers here
                      // e.g. addToCart({ ...productMain }); openModalCart();
                    }}
                    onError={(err) => {
