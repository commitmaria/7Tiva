            ...
            <div className="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
              ...
              <div className="list-action mt-6">
                ...
                <div className="more-infor mt-6">
                  ...
                  <div className="flex items-center gap-1 mt-3">
                    ...
                    <div className="text-secondary">Instant / 1 Hour</div>
                  </div>
                  <div className="flex items-center gap-1 mt-3">
              ...
              <div className="get-it mt-6">
                ...
                <div className="item flex items-center gap-3 mt-4">
                  ...
                  <div>
                    <div className="text-title">6 Days Returns</div>
                    <div className="caption1 text-secondary mt-1">
                      Not impressed? Get a refund. You have 6 Dayss to break
                      our hearts.
                    </div>
                  </div>
                </div>
                    ...
                    <div className="item">
                      <div className="heading flex items-center justify-between">
                        <div className="user-infor flex gap-4">
                          ...
                          <div className="user">
                            <div className="flex items-center gap-2">
                              <div className="text-title">Jen R.</div>
