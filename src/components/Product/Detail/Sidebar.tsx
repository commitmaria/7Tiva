...
const Sidebar: React.FC<Props> = ({ data, productId }) => {
  ...
  // dynamic total for PayPal (price × selected quantity)
  const totalPrice =
    (Number(String(productMain.price).replace(/,/g, "")) || 0) *
    (productMain.quantityPurchase || 1);
                    ...
                    .map((item) => (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="text-title mt-1">${item.price}</div>
                        </div>
                      </div>
                    ))}
                </div>
                ...
                <div className="product-infor lg:w-1/2 w-full">
                  ...
                  <div className="list-action mt-6">
                    ...
                    <div className="button-block mt-5">
                      {/* PayPalButton*/}
                      <PayPalButton
                        key={`sidebar-${productMain.id}-${productMain.quantityPurchase}-${totalPrice}`}
                        amount={totalPrice}
                        onSuccess={(details) => {
                          console.log("✅ PayPal payment successful:", details);
                          alert("Payment successful!");
                          // You can call addToCart({...productMain}) or openModalCart() if you want to reflect the purchase
                        }}
                        onError={(err) => {
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 gap-y-5">
                      <div className="left">
                        ...
                        <div className="text-secondary mt-2">
                          ...
                          provided through our network of authorized partners
                          and distributors to ensure a safe and reliable
                          experience. We do not sell or provide any cracked or
                          pirated versions; every license comes directly from an
                          official provider or authorized distributor. Once your
                          payment is completed, you will immediately receive a
                          message containing a download link or license code
                          along with step-by-step activation instructions. Our
                          support team is available to assist you with any
                          activation or usage issues. We are committed to
                          transparency, compliance with the law, and respecting
                      ...
                      <div className="right">
                        ...
                        <div className="list-feature">
                          ...
                          <div className="item flex gap-1 text-secondary mt-1">
                            <Icon.Dot size={28} />
                            <p>
                              We do not provide cracked or pirated versions;
                              each license comes from an official distributor.
                            </p>
                          </div>
                          <div className="item flex gap-1 text-secondary mt-1">
                            <Icon.Dot size={28} />
